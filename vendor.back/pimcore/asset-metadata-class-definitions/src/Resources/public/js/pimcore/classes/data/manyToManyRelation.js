...
pimcore.registerNS("pimcore.plugin.asset_metadata_class_definitions.bundle.classes.data.manyToManyRelation");
pimcore.plugin.asset_metadata_class_definitions.bundle.classes.data.manyToManyRelation = Class.create(pimcore.plugin.asset_metadata_class_definitions.bundle.classes.data.data, {
