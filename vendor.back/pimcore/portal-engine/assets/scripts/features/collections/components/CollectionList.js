...
import CollectionListItem from "~portal-engine/scripts/features/collections/components/CollectionListItem";
...
import {requestListPage, setup, urlChanged} from "~portal-engine/scripts/features/collections/collections-actions";
import {
...
import CollectionListPagination from "~portal-engine/scripts/features/collections/components/CollectionListPagination";
    ...
    return isFetching ? (
        ...
        resultCount === 0 ? (
            <div className="row justify-content-center my-4 my-lg-5">
                <div className="col-6">
                    <div className="h3 text-center"><Trans t="collection.no-results"/></div>
                </div>
            </div>
        ) : (
            <Fragment>
                <div className="data-table-container">
                    <div className="data-table table-responsive">
                        <table className="table">
                            <thead>
                            <tr>
                                <th><Trans t="collection.list.name"/></th>
                                <th><Trans t="collection.list.item-count"/></th>
                                <th><Trans t="collection.list.creation-date"/></th>
                                <th><span className="sr-only"><Trans t="collection.list.actions"/></span></th>
                            </tr>
                            </thead>
                            <tbody>
                            {ids.map((id) => (
