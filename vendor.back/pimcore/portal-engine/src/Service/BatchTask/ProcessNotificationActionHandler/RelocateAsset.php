...
class RelocateAsset implements ProcessNotificationActionInterface
{
    /**
    ...
    {
        return $batchTask->getType() === Type::RELOCATE_ASSET;
    }
    ...
    {
        return $batchTask->getPayload()[AssetRelocate::TARGET_PAGE] ?? '/';
    }
}
