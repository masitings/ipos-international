...
/**
 * Can be used to deny or allow the create permission of an element for the current user.
 */
class DataPoolCreateItemEvent extends DataPoolItemPermissionEvent
{
}
