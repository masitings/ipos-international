...
/**
 * Can be used to deny or allow the delete permission of an element for the current user.
 */
class DataPoolDeleteItemEvent extends DataPoolItemPermissionEvent
{
}
