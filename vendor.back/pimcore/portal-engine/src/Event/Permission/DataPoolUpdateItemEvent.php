...
/**
 * Can be used to deny or allow the update permission of an element for the current user.
 */
class DataPoolUpdateItemEvent extends DataPoolItemPermissionEvent
{
}
