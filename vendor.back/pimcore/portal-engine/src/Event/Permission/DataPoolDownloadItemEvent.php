...
/**
 * Can be used to deny or allow the download permission of an element for the current user.
 */
class DataPoolDownloadItemEvent extends DataPoolItemPermissionEvent
{
}
