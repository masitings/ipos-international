...
/**
* @method static \Pimcore\Model\DataObject\TenderQuotationFaq\Listing getList(array $config = [])
* @method static \Pimcore\Model\DataObject\TenderQuotationFaq\Listing|\Pimcore\Model\DataObject\TenderQuotationFaq|null getByQuestion(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\TenderQuotationFaq\Listing|\Pimcore\Model\DataObject\TenderQuotationFaq|null getByQuestionType(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\TenderQuotationFaq\Listing|\Pimcore\Model\DataObject\TenderQuotationFaq|null getByAnswer(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\TenderQuotationFaq\Listing|\Pimcore\Model\DataObject\TenderQuotationFaq|null getByVideoTime(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
*/

class TenderQuotationFaq extends Concrete
{
