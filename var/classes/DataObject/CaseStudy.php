...
/**
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing getList(array $config = [])
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByLocalizedfields(string $field, mixed $value, ?string $locale = null, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByTitle(mixed $value, ?string $locale = null, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByAuthor(mixed $value, ?string $locale = null, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByContent(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByReleaseDate(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByCoverView(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByLatest(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByResourceType(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByVideoTime(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByInterestedTitle(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByInterestedList(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByShares(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByBookChat(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getBySeoTitle(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getBySeoDescription(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\CaseStudy\Listing|\Pimcore\Model\DataObject\CaseStudy|null getByTags(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
*/

class CaseStudy extends Concrete
{
...
* @return \Pimcore\Model\DataObject\Course[]|\Pimcore\Model\DataObject\CoursesDemand[]|\Pimcore\Model\DataObject\Events[]|\Pimcore\Model\DataObject\News[]|\Pimcore\Model\DataObject\BookChar[]|\Pimcore\Model\DataObject\Articles[]|\Pimcore\Model\DataObject\Business[]|\Pimcore\Model\DataObject\CaseStudy[]|\Pimcore\Model\DataObject\PatentAnalytic[]|\Pimcore\Model\DataObject\WebinarRecordings[]
*/
...
* @param \Pimcore\Model\DataObject\Course[]|\Pimcore\Model\DataObject\CoursesDemand[]|\Pimcore\Model\DataObject\Events[]|\Pimcore\Model\DataObject\News[]|\Pimcore\Model\DataObject\BookChar[]|\Pimcore\Model\DataObject\Articles[]|\Pimcore\Model\DataObject\Business[]|\Pimcore\Model\DataObject\CaseStudy[]|\Pimcore\Model\DataObject\PatentAnalytic[]|\Pimcore\Model\DataObject\WebinarRecordings[] $interestedList
* @return $this
*/
...
* @return \Pimcore\Model\DataObject\BookChar|null
*/
...
* @param \Pimcore\Model\DataObject\BookChar|null $bookChat
* @return $this
*/
