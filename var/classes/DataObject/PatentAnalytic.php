...
/**
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing getList(array $config = [])
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByLocalizedfields(string $field, mixed $value, ?string $locale = null, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByTitle(mixed $value, ?string $locale = null, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByAuthor(mixed $value, ?string $locale = null, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByContent(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByReleaseDate(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByCoverView(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByLatest(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByResourceType(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByInterestedTitle(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByInterestedList(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByShares(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getBySeoTitle(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getBySeoDescription(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByTags(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\PatentAnalytic\Listing|\Pimcore\Model\DataObject\PatentAnalytic|null getByVideoTime(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
*/

class PatentAnalytic extends Concrete
{
