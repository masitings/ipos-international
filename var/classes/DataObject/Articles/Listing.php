...
namespace Pimcore\Model\DataObject\Articles;

use Pimcore\Model;
use Pimcore\Model\DataObject;

/**
 * @method DataObject\Articles|false current()
 * @method DataObject\Articles[] load()
 * @method DataObject\Articles[] getData()
 * @method DataObject\Articles[] getObjects()
 */
...
/**
* Filter by coverView (Overview Feature)
* @param string|int|float|array|Model\Element\ElementInterface $data  comparison data, can be scalar or array (if operator is e.g. "IN (?)")
* @param string $operator  SQL comparison operator, e.g. =, <, >= etc. You can use "?" as placeholder, e.g. "IN (?)"
* @return $this
*/
...
/**
* Filter by articleType (Article Type)
* @param string|int|float|array|Model\Element\ElementInterface $data  comparison data, can be scalar or array (if operator is e.g. "IN (?)")
* @param string $operator  SQL comparison operator, e.g. =, <, >= etc. You can use "?" as placeholder, e.g. "IN (?)"
* @return $this
*/
public function filterByArticleType ($data, $operator = '='): static
{
	$this->getClass()->getFieldDefinition("articleType")->addListingFilter($this, $data, $operator);
	return $this;
}

/**
* Filter by resourceType (Resource Type)
* @param string|int|float|array|Model\Element\ElementInterface $data  comparison data, can be scalar or array (if operator is e.g. "IN (?)")
* @param string $operator  SQL comparison operator, e.g. =, <, >= etc. You can use "?" as placeholder, e.g. "IN (?)"
* @return $this
*/
...
/**
* Filter by relatedArticles (Content)
* @param mixed $data
* @param string $operator SQL comparison operator, e.g. =, <, >= etc. You can use "?" as placeholder, e.g. "IN (?)"
* @return $this
*/
public function filterByRelatedArticles ($data, $operator = '='): static
{
	$this->getClass()->getFieldDefinition("relatedArticles")->addListingFilter($this, $data, $operator);
	return $this;
}
...
/**
* Filter by bookChat (IA Chat URL)
* @param mixed $data
* @param string $operator SQL comparison operator, e.g. =, <, >= etc. You can use "?" as placeholder, e.g. "IN (?)"
* @return $this
*/
public function filterByBookChat ($data, $operator = '='): static
{
	$this->getClass()->getFieldDefinition("bookChat")->addListingFilter($this, $data, $operator);
	return $this;
}
